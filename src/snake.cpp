...
Snake::Snake() {
    ...
    if(!(body_texture.loadFromFile("res/body.png")) && !(body_texture.loadFromFile("/usr/share/snake/res/body.png"))) exit(3);

    if(!(head_texture.loadFromFile("res/head.png")) && !(head_texture.loadFromFile("/usr/share/snake/res/head.png"))) exit(3);

    if(!(eat_texture.loadFromFile("res/eat.png")) && !(eat_texture.loadFromFile("/usr/share/snake/res/eat.png"))) exit(3);

    if(!(dejavu.loadFromFile("res/DejaVuSansMono.ttf")) && !(dejavu.loadFromFile("/usr/share/snake/res/DejaVuSansMono.ttf"))) exit(4);
